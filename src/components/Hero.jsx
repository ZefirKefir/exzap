  ...
  return (
    <section className='container flex flex-col items-center justify-center gap-12 px-5 mx-auto mb-20 mt-36 md:my-40 hero md:px-8 xl:px-10 md:flex-row lg:gap-28'>
      ...
      <div className='relative w-full ml-[20%] xs:-ml-[5%] aspect-5/3 grow'>
        {/* decor start*/}
        <div className='absolute left-0 w-12 bg-red-800 rounded-full sm:w-40 top-1/5 aspect-square animate-ping' />
        <div className='absolute w-12 delay-300 bg-red-900 rounded-full translate-x-1/5 -bottom-1/6 sm:w-40 right-1/2 aspect-square animate-ping-slow' />
        <div className='absolute right-0 w-20 bg-red-900 rounded-full sm:w-60 top-1/5 aspect-square animate-ping' />
        {/* decor end */}
